    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden pt-12 pb-16 sm:pt-16 sm:pb-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
          <div className="inline-flex items-center gap-2 rounded-full border border-blue-200 bg-blue-50/70 px-3.5 py-1 text-xs font-mono text-blue-700 font-medium">
            <Cpu className="h-3.5 w-3.5 text-blue-600" />
            <span>Interactive Distributed Systems Simulator</span>
          </div>

          <h1 className="text-3xl sm:text-5xl font-semibold tracking-[-0.03em] text-slate-900 leading-[1.15]">
      ...
      {/* 6. BOTTOM CTA */}
      <section className="py-20 sm:py-28 text-center border-t border-slate-200 bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 text-white relative">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 relative z-10 space-y-6">
          <span className="inline-flex items-center gap-1.5 rounded-full border border-white/20 bg-white/10 px-3.5 py-1 text-xs font-mono text-slate-200">
          ...
          <div className="pt-2">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-white px-7 py-3.5 text-sm font-semibold text-slate-950 hover:bg-slate-100 transition active:scale-[0.99] shadow-sm"
            >
              <span>Launch Free Architecture Studio</span>
              <ArrowRight className="h-4 w-4" />
            </a>
