...
export const HomePage: React.FC<HomePageProps> = ({ onOpenWaitlist }) => (
  <div className="bg-white text-slate-900">
    <section className="border-b border-slate-100 bg-gradient-to-b from-blue-50/80 to-white py-20 sm:py-28">
      <div className="mx-auto max-w-5xl px-4 text-center sm:px-6 lg:px-8">
        ...
        <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row"><button onClick={onOpenWaitlist} className="inline-flex items-center justify-center gap-2 rounded-lg bg-blue-600 px-6 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-blue-700">Join early access <ArrowRight className="h-4 w-4" /></button><a href="#how-it-works" className="inline-flex items-center justify-center rounded-lg border border-slate-300 bg-white px-6 py-3 text-sm font-semibold text-slate-700 transition hover:bg-slate-50">See how it works</a></div>
        <p className="mt-4 text-xs text-slate-500">No payment required to join the early-access list.</p>
      </div>
    </section>
    ...
    <section className="py-20 text-center"><div className="mx-auto max-w-2xl px-4 sm:px-6"><h2 className="text-3xl font-bold tracking-tight">Start preparing with more clarity.</h2><p className="mt-3 text-sm text-slate-600">Join the early-access list and we’ll let you know when PrepVisor is ready for you.</p><button onClick={onOpenWaitlist} className="mt-7 inline-flex items-center gap-2 rounded-lg bg-blue-600 px-6 py-3 text-sm font-semibold text-white shadow-sm hover:bg-blue-700">Join early access <ArrowRight className="h-4 w-4" /></button></div></section>
  </div>
)
