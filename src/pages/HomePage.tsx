...
export const HomePage: React.FC<HomePageProps> = () => (
  <div className="flex flex-col">
    {/* Hero Section */}
    <section className="relative overflow-hidden pt-12 pb-20 sm:pt-20 sm:pb-28 text-center bg-gradient-to-b from-blue-50/50 via-white to-white">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        <div className="inline-flex items-center gap-2 rounded-full border border-blue-200 bg-blue-50/80 px-3.5 py-1.5 text-xs font-semibold text-blue-700 shadow-xs">
          <Sparkles className="h-3.5 w-3.5 text-blue-600" />
          <span>Interactive AI Interview Workbench</span>
        </div>
        ...
        <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row items-center">
          <a
            ...
            onClick={() => trackEvent("landing_cta_clicked", { cta: "hero_start_free", location: "hero" })}
          ...
          <a
            ...
            onClick={() => trackEvent("landing_cta_clicked", { cta: "hero_login", location: "hero" })}
    ...
    <section className="py-20 text-center">
      <div className="mx-auto max-w-2xl px-4 sm:px-6 space-y-4">
        ...
        <div className="pt-3">
          <a
            href={decorateUrlWithUtms(`${COMPANY_CONFIG.appUrl}/register`)}
            onClick={() => trackEvent("landing_cta_clicked", { cta: "bottom_start_free", location: "bottom_cta" })}
