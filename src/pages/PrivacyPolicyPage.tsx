      ...
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 space-y-10">
        ...
        <div className="space-y-6 text-xs sm:text-sm leading-relaxed text-slate-600">
          <section className="space-y-2">
            <h2 className="text-base font-semibold text-slate-900">1. Data Fiduciary & Controller</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-base font-semibold text-slate-900">3. How We Use Your Data</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-base font-semibold text-slate-900">4. How We Protect Data & Payment Security</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-base font-semibold text-slate-900">5. Grievance Redressal Officer</h2>
            <p>
